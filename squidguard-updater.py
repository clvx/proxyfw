...
# TODO: Propósito del script es actualizar la BD de squidguard agregando cada
# uno de los elementos de la lista de shallalist a /var/lib/squidguard/db/.
# Luego, agregar los dominios en domainlist de /etc/squid/squidGuard.conf y
# denegarlos en la parte del dominio. Finalmente actualizar la BD de squidguard
# y reconfigurar script.
...
dirname = []
domains = ""
block_url = "172.0.0.1/block.html"
